...
graph TB
    ...
    docs_DOCUMENTATION_GRAPH_md --> docs_INDEX_md
    docs_DOCUMENTATION_GRAPH_md --> docs_REPOSITORY_STRUCTURE_md
    docs_DOCUMENTATION_GRAPH_md --> docs_SYSTEM_ARCHITECTURE_md
